...
*A similar lightweight and fast tool [onex](https://github.com/mrveerroy/tool-x-turmux.git) is available. We can use onex instead of Tool-X*
...
* `git clone https://github.com/mrveerroy/tool-x-turmux.git`
